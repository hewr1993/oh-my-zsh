...
function preexec_update_git_vars() {
    case "$1" in		# original command
        git*)
        __EXECUTED_GIT_COMMAND=1
        ;;
    esac

    case "$2" in		# aliased command
        git*)
        __EXECUTED_GIT_COMMAND=1
        ;;
    esac
...
ZSH_THEME_GIT_PROMPT_BRANCH="%{$fg[blue]%}%{$fg_bold[magenta]%}"
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg[blue]%}%{$fg[red]%}●%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_DIRTY="%{$fg[blue]%}%{$fg[yellow]%}✗%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%{$fg[blue]%}%{$fg[red]%}✖%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_CHANGED="%{$fg[blue]%}%{$fg[blue]%}✚%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_REMOTE=""
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$fg[blue]%}%{$fg[blue]%}…%{$reset_color%}"
